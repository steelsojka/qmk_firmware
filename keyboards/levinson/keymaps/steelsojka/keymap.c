 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 | Tab  |   4  |   5  |   6  |   +  |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |   1  |   2  |   3  |   /  |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      | Space|   0  |   0  |   .  |   *  |      |
...
[_PAD] = LAYOUT_ortho_4x12( \
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,  KC_F6,    _______, KC_7, KC_8, KC_9,   KC_MINUS, KC_BSPC, \
  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, KC_F12,   KC_TAB , KC_4, KC_5, KC_6,   KC_PLUS,  _______, \
  _______, _______, _______, _______, _______, _______, _______, KC_1, KC_2, KC_3,   KC_SLASH, KC_ENTER, \
...
[_ADJUST] =  LAYOUT_ortho_4x12( \
  EEP_RST, RESET  , _______, _______,  RGB_SAD, RGB_SAI, _______,  _______,  _______,  _______,  _______, _______,\
  _______, RGB_TOG, RGB_MOD, RGB_RMOD, RGB_HUD, RGB_HUI, QWERTY ,  COLEMAK,  _______,  _______,  _______, _______, \
  _______, BL_TOGG, BL_STEP, BL_BRTG,  BL_DEC,  BL_INC,  _______,  _______,  _______,  _______,  _______, _______, \
