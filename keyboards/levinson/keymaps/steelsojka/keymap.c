 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | PAD  | Ctrl | Alt  | GUI  |Lower |Space |Space | Raise| GUI  | Alt  | Ctrl |      |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT( \
  ...
  PAD,  KC_LCTL,     KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RGUI, KC_RALT, KC_RCTL, _______ \
),
 ...
 */
[_PAD] = LAYOUT( \
  _______, _______, _______, _______, _______, _______, _______, KC_7, KC_8, KC_9, KC_MINUS,  KC_BSPC, \
