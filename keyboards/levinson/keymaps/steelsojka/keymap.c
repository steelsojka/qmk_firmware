...
#define RSFT_SP MT(MOD_RSFT, KC_SPC)
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | PAD  | Ctrl | Alt  | GUI  |Lower |Space |Rs/Sp | Raise| GUI  | Alt  | Ctrl | PAD  |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT( \
  ...
  PAD,      KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  RSFT_SP, RAISE,   KC_RGUI, KC_RALT, KC_RCTL, PAD \
),
...
/* Lower
 * ,-----------------------------------------------------------------------------------.
 * |      |      |  F7  |  F8  |  F9  | F10  |      |   7  |   8  |   9  |   -  | Bksp |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |  F4  |  F5  |  F6  | F11  |      |   4  |   5  |   6  |   +  |      | 
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |  F1  |  F2  |  F3  | F12  |      |   1  |   2  |   3  |   /  |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |   0  |   0  |   .  |   *  |      |
 * `-----------------------------------------------------------------------------------'
 */
[_PAD] = LAYOUT( \
  _______, _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, KC_7, KC_8, KC_9, KC_MINUS,  KC_BSPC, \
  _______, _______, KC_F4,   KC_F5,   KC_F6,   KC_F11,  _______, KC_4, KC_5, KC_6, KC_PLUS,   _______, \
  _______, _______, KC_F1,   KC_F2,   KC_F3,   KC_F12,  _______, KC_1, KC_2, KC_3, KC_SLASH,  KC_ENTER, \
